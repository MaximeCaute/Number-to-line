class Instructions {
  static toHTMLPages(localizer) {
    return [
      ...
      `<img src="res/LineIllustration.png" alt="line illustration" style= "width: calc(
      ...
      `<img src="res/ButtonClickIllustration.png" alt="cardboard illustration" style="height: calc(
      ...
      `<img src="res/ResponseIllustration.png" alt="click illustration" style= "width: calc(
        ${GUI_CONFIG.BAR_WIDTH} + 2 * ${GUI_CONFIG.OUT_OF_LINE_RESPONSE_PANELS_WIDTH})">` +
